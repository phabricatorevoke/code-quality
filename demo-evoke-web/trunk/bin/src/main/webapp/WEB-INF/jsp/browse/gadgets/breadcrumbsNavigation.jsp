...
<dsp:page>
  ...
  <c:choose>
    ...
    <c:otherwise>
      <%--
        If categoryNavIds is empty, use the shopper's current category as the default category item.   
     
        Input Parameters:
          navAction - 'jump' means that we reset history and add the current category as the first entry
          item - this is the item to add to the breadcrumb stack
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/browse/gadgets/breadcrumbsNavigation.jsp#3 $$Change: 729607 $--%>
