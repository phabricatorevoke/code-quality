        ...
        <dsp:droplet name="WoodFinishDroplet">
          ...
          <dsp:oparam name="output">  
            <dsp:form method="post" action="${uri}" id="pickerForm" formid="pickerForm">
              <dsp:input type="hidden" bean="CartFormHandler.skuType" value="furniture" />
                  ...
                  <div class="atg_store_pickerContainer">
                    ...
                    <div class="atg_store_addQty">
                      <div class="atg_store_quantity"> 
                        ...
                        <dsp:input bean="CartFormHandler.quantity" id="${qty_input_id}" class="atg_store_quantityField_nojs" value="1" size="2" maxlength="5" />
                      ...
                      <div class="atg_store_productAvailability">
                        <span class="atg_store_basicButton add_to_cart_link">
                          ...
                          <dsp:input bean="CartFormHandler.addItemToOrder" type="submit" iclass="atg_behavior_addItemToCart" value="${addToCartCaption}"/>
                        </span>
                      </div>
                    </div>
                  </div>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/browse/gadgets/noJsWoodFinishPickerLayout.jsp#1 $$Change: 713790 $--%>
