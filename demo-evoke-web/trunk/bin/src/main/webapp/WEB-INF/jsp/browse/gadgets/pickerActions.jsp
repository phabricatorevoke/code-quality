        ...
        <li class="atg_store_giftListsActions atg_store_dropDownParent">
          ...
          <div class="atg_store_giftListMenuContainer atg_store_dropDownChild">
            ...
            <ul class="atg_store_giftListMenu">
              ...
              <dsp:input type="hidden" bean="CartFormHandler.addItemToGiftlistErrorURL" 
                         value="${productUrl}"/>
              ...
              <c:forEach var="giftlist" items="${giftlists}" varStatus="status">
                ...
                <li>
                  ...
                  <dsp:input type="submit" bean="CartFormHandler.addItemToGiftlist" 
      ...
      <li class="atg_store_wishListsActions ${wishlistContainsSku ? 'atg_store_viewWishlist' : ''}">
        <c:choose>
          <c:when test="${not wishlistContainsSku}">
            ...
            <dsp:input type="hidden" bean="CartFormHandler.addItemToGiftlistErrorURL" value="${productUrl}"/>
            <dsp:input type="submit" iclass="atg_store_textButton" bean="CartFormHandler.addItemToGiftlist" 
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/browse/gadgets/pickerActions.jsp#1 $$Change: 713790 $--%>