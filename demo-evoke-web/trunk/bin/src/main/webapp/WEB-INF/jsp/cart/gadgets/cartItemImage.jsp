<%-- 
  ...
  Form Conditions:
    ...
    CartFormHandler must be invoked from a submit button in this form 
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/gadgets/cartItemImage.jsp#1 $$Change: 713790 $--%>
