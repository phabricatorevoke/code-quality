<%-- 
  This gadget renders the header for the item list on the Shopping Cart page. It then iterates through the cart, rendering
  each item.
  Details included with each item are:
    Availability,
...
<dsp:page>
  ...
  <c:if test="${not empty items}">
    ...
    <table summary="${cartItemsTableSummary}" id="atg_store_itemTable" cellspacing="0" cellpadding="0" border="0">
                       ...
                       <tr class="<crs:listClass count="${count}" size="${fn:length(items)}" selected="false"/>">
                          ...
                          <td class="quantity">                                                
                            ...
                            <c:choose>
                              ...
                              <c:otherwise>
                                <fieldset>
                                  <input class="text qty atg_store_numericInput" type="text" title="<fmt:message key="common.qty" />" name="<dsp:valueof param='currentItem.id'/>"
                                         value="<dsp:valueof value='${missedQty}'/>" dojoType="atg.store.widget.enterSubmit"
                                  ...
                                  <dsp:input id="atg_store_update" iclass="atg_store_textButton" type="submit"
                                             bean="CartFormHandler.update" value="${updateItemText}"/>
                                </fieldset>
                              </c:otherwise>
                            </c:choose>
                          </td>
                      ...
                      <td class="quantity">
                        ...
                        <c:choose>
                          ...
                          <c:otherwise>
                            <fieldset>
                              <input class="text qty atg_store_numericInput" type="text" title="<fmt:message key="common.qty" />" name="<dsp:valueof param='currentItem.id'/>"
                                     value="<dsp:valueof param='currentItem.quantity'/>" dojoType="atg.store.widget.enterSubmit"
                                     targetButton="atg_store_update">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/gadgets/cartItems.jsp#2 $$Change: 713816 $--%>
