          ...
          <tr>
            ...
            <td class="item giftItemName" scope="row" abbr="<fmt:message key="common.freeGiftPlaceholder"/>">
              ...
              <%--
               ...
               --%>
               <a href="#" class="atg_store_basicButton atg_store_gwpSelectButton" onclick="dijit.byId('giftSelectorDialog').href='${selectionUrl}'; dijit.byId('giftSelectorDialog').refresh(); dijit.byId('giftSelectorDialog').show();">
                 <span>
                   <fmt:message key="common.select"/>
                 </span>
               </a>
            ...
            <td class="cartActions">
              <ul> 
                <li>
                  ...
                  <%-- 
                    Add the GWP placeholder promotion id and hashcode for this placeholder into the associated array  
                    in the formhandler. When removing the placeholder These can then be referenced in the formhandler 
                    by using the 'gwpRowCount' value as the index into the array.
                  --%>
                  <dsp:input type="hidden" bean="CartFormHandler.gwpPlaceholderPromotionIds" paramvalue="selection.promotionId"/>
                  <dsp:input type="hidden" bean="CartFormHandler.gwpPlaceholderHashCodes" paramvalue="selection.giftHashCode"/>

                  <dsp:input iclass="atg_store_textButton atg_store_actionDelete" 
                             type="submit" submitvalue="${gwpRowCount}"
                             bean="CartFormHandler.removeGwpPlaceholderFromOrder" value="${removeText}"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/gadgets/giftPlaceholders.jsp#1 $$Change: 713790 $--%>
