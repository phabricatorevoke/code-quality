...
<dsp:page>
  ...
  <crs:pageContainer divId="atg_store_gwpNoJS" bodyClass="atg_store_pageCart atg_store_gwpNoJS" titleKey="" index="false" follow="false">
      ...
      <div class="atg_store_main" id="atg_store_shoppingCart">
        ...
        <dsp:form action="${pageContext.request.requestURI}" method="post" name="gwpform" formid="gwpform">
          ...
          <div id="atg_store_gwpFooter" class="atg_store_formActions">
            <%-- Apply selection --%>
            <c:if test="${itemsOutOfStock ne true}">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/gadgets/noJsGiftSelection.jsp#1 $$Change: 713790 $--%>