...
<dsp:page>
  ...
  <%--
    If there is an 'editCard' specified on the B2CProfileFormHandler, we should re-post it 
  ...
  <c:choose>
      ...
      <c:choose>
        ...
        <c:when test="${not empty editCoupon}">
          ...
          <span class="atg_store_orderSummaryItem atg_store_couponCode">
            <dsp:input bean="CouponFormHandler.couponCode" priority="10" type="text" id="atg_store_promotionCodeInput"
                       value="${couponCode}" autocomplete="off" dojoType="atg.store.widget.enterSubmit" targetButton="atg_store_applyCoupon" />
        ...
        <c:otherwise>
          ...
          <span class="atg_store_appliedCouponCode atg_store_orderSummaryItem">
            ...
            <%--
              If there is an 'editCard' specified on the B2CProfileFormHandler, we should re-post
    ...
    <c:otherwise>
      ...
      <span class="atg_store_couponCode atg_store_orderSummaryItem">
        <dsp:input bean="CouponFormHandler.couponCode" priority="10" type="text" id="atg_store_promotionCodeInput" autocomplete="off" dojoType="atg.store.widget.enterSubmit" targetButton="atg_store_applyCoupon" />
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/gadgets/promotionCode.jsp#1 $$Change: 713790 $--%>