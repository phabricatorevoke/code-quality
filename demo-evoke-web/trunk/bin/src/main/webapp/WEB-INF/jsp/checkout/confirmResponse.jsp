<%--
  This is the final 'Checkout Success' page.
  It checks, if current user is already registered or not. If the user is not registered, this page will display the Register pane
  with all necessary input fields.
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/confirmResponse.jsp#1 $$Change: 713790 $--%>
