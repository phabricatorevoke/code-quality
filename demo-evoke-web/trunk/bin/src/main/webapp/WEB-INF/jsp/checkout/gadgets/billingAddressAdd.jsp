  ...
  <dsp:importbean bean="/atg/userprofiling/Profile"/>
    ...
    <ul class="atg_store_basicForm atg_store_addNewAddress">
      ...
      <dsp:include page="/global/gadgets/addressAddEdit.jsp">
        <dsp:param name="formHandlerComponent" value="/atg/store/order/purchase/BillingFormHandler.creditCardBillingAddress"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/gadgets/billingAddressAdd.jsp#2 $$Change: 713816 $--%>