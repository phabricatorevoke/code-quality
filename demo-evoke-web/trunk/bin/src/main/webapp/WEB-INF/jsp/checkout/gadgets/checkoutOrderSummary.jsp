<%-- 
  This gadget renders brief order summary for the checkout pages.
  It displays:
    1. order subtotal
    2. applied discounts
    3. shipping price
            ...
            <span class="atg_store_orderSummaryItem">
              ...
              <dsp:include page="/global/gadgets/formattedPrice.jsp">
                <%--
                  ...
                  store credits to pay for order, dislpay order's total. Display store credits otherwise.
                --%>
        ...
        <dsp:droplet name="TargetingArray">
          ...
          <dsp:oparam name="output">
            <li class="atg_store_stackingMessage">
              <dsp:a href="${pageContext.request.contextPath}/global/gadgets/promotionDetailsPopup.jsp" target="popup">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/gadgets/checkoutOrderSummary.jsp#1 $$Change: 713790 $--%>
