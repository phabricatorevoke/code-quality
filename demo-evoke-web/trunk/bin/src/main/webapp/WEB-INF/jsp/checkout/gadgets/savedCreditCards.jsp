              ...
              <dl>
                ...
                <ul class="atg_store_storedCreditCardsActions">
                  <li class="last">
                    ...
                    <dsp:a bean="B2CProfileFormHandler.editCard" page="../creditCardEdit.jsp" value="${userCard.key}" title="${editCardTitle}">
        ...
        <div class="atg_store_billingEnterCardCSV">
          ...
          <ul class="atg_store_basicForm">
            <li class="atg_store_ccCsvCode">
              <label for="atg_store_existingVerificationNum"><fmt:message key="checkout_billing.securityCode"/></label>

              <dsp:input bean="BillingFormHandler.creditCardVerificationNumber" value="" type="text"
                        iclass="required" id="atg_store_existingVerificationNum" autocomplete="off" dojoType="atg.store.widget.enterSubmit" targetButton="atg_store_continueButton" />
              <fmt:message var="whatisThisTitle" key="checkout_billing.whatIsThis"/>
              <a href="${pageContext.request.contextPath}/checkout/whatsThisPopup.jsp" title="${whatisThisTitle}" class="atg_store_help" target="popup">${whatisThisTitle}</a>
            </li>
          </ul>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/gadgets/savedCreditCards.jsp#1 $$Change: 713790 $--%>
