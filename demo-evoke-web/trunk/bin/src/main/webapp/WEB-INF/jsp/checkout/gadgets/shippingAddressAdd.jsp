        ...
        <li class="last option">
          <label for="atg_store_addressAddSaveAddressInput"><fmt:message key="checkout_addressAdd.saveAddress"/></label>
            <dsp:input type="checkbox" 
                       name="atg_store_addressAddSaveAddressInput"
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/gadgets/shippingAddressAdd.jsp#1 $$Change: 713790 $--%>
