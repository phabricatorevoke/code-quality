<%-- 
  This page renders the shipping-multiple form. It renders necessary hidden fields and includes shipipngMultipleDestinations.jsp page.
  ...
  <div id="atg_store_checkout" class="atg_store_main">
    <div class="atg_store_checkoutOption">
     ...
     <%-- INITALIZE COMMERCE SHIPPING OBJECTS --%>
      ...
      <%-- Success/error URLs. --%>
      <dsp:input type="hidden" bean="ShippingGroupFormHandler.shipToMultipleAddressesSuccessURL" value="billing.jsp"/>
      <dsp:input type="hidden" bean="ShippingGroupFormHandler.shipToMultipleAddressesErrorURL" value="shippingMultiple.jsp?init=true"/>
      ...
      <fieldset class="atg_store_checkoutContinue">
        <div class="atg_store_formActions">
          ...
          <span class="atg_store_basicButton">
            <dsp:input type="submit"  bean="ShippingGroupFormHandler.shipToMultipleAddresses" value="${continueButtonText}"/>
          </span>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/gadgets/shippingMultipleForm.jsp#1 $$Change: 713790 $--%>
