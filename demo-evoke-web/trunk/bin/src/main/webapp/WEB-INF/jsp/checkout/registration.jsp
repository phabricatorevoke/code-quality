<%--
  This page dislplays all necessary fields for the user to be got registered.
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/registration.jsp#1 $$Change: 713790 $--%>
