<%--
  This page allows the user to select shipping method for single shipping (i.e. all products are shipped to the same address).
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/shippingMethod.jsp#1 $$Change: 713790 $--%>
