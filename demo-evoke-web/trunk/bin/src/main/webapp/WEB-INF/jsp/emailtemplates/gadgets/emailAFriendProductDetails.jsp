      ...
      <div style="margin-top:20px;">
        <table border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td align="center" 
                style="background-color:#386088;padding-left:8px;padding-right:8px;text-align:center;font-family:Verdana,arial,sans-serif;font-size:12px;font-weight:bold">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/emailtemplates/gadgets/emailAFriendProductDetails.jsp#2 $$Change: 713816 $--%>
