      ...
      <table border="0" cellpadding="0" cellspacing="0" width="609" 
        ...
        <tr>
          <td style="color:#666;font-family:Tahoma,Arial,sans-serif;">
            ...
            <fmt:message var="linkText" key="common.here"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/emailtemplates/newPassword.jsp#1 $$Change: 713790 $--%>
