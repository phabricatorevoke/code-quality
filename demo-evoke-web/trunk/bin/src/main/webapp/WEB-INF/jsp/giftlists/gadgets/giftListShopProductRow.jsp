          ...
          <c:choose>
            ...
            <c:otherwise>
              <dsp:form id="addToCart" formid="addToCart"
                ...
                <dsp:input bean="CartFormHandler.productId" paramvalue="product.repositoryId" 
                           type="hidden"/>
                <dsp:input bean="CartFormHandler.catalogRefIds" paramvalue="sku.repositoryId" 
                           type="hidden"/>                   
                <dsp:input bean="CartFormHandler.giftlistItemId" paramvalue="giftlistItem.id" 
                           type="hidden"/>
                <dsp:input bean="CartFormHandler.giftlistId" paramvalue="giftlist.id" 
                           type="hidden"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/giftlists/gadgets/giftListShopProductRow.jsp#4 $$Change: 737097 $--%>
