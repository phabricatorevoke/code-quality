...
<dsp:page>
  <crs:pageContainer divId="atg_store_giftListIntro" 
    ...
    <div id="atg_store_giftListShop">      
      ...
      <%-- 
        Display error messages for CartFormHandler if some error occurred during
        adding item to cart.
       --%>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/giftlists/giftListShop.jsp#2 $$Change: 713816 $ --%>
