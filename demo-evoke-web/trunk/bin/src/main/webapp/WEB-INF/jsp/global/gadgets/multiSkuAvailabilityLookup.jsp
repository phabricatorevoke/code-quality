<%-- 
  ...
  Form Condition:
    This gadget must be contained inside of a form. CartFormHandler must be invoked from 
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/global/gadgets/multiSkuAvailabilityLookup.jsp#3 $$Change: 735941 $--%>
