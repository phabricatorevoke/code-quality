...
<dsp:page>
  ...
  <crs:mobilePageContainer titleString="${pageTitle}">
    ...
    <div class="dataContainer">
      <%-- Display "MobileB2CProfileFormHandler" error messages, which were specified in "formException.message" --%>
      <dsp:include page="${mobileStorePrefix}/global/gadgets/errorMessage.jsp">
        <dsp:param name="formHandler" bean="MobileB2CProfileFormHandler"/>
      </dsp:include>
      ...
      <ul class="dataList" role="presentation">
        ...
        <dsp:droplet name="MapToArrayDefaultFirst">
          ...
          <dsp:oparam name="output">
            ...
            <c:forEach var="shippingAddress" items="${sortedArray}" varStatus="status">
              ...
              <c:url value="myaccountAddressDetail.jsp" var="editURL">
              ...
              <li>
                <div class="content">
                  ...
                  <c:if test="${status.count == 1 && not empty defaultAddr}">
                    <span class="defaultLabel"><fmt:message key="mobile.common.defaultAddress"/></span>
                  </c:if>
                </div>
                <fmt:message var="addrEditTitle" key="mobile.myaccount_accountAddressEdit.title"/>
                <dsp:a href="${editURL}" bean="MobileB2CProfileFormHandler.editAddress" paramvalue="shippingAddress.key"
        ...
        <li>
          <dsp:a page="myaccountAddressDetail.jsp?addrType=shipping&addrOper=add" class="icon-ArrowRight">
