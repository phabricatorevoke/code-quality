...
<dsp:page>
  ...
  <fmt:message key="mobile.common.foot.shipping" var="pageTitle"/>
          ...
          <div class="moveItems">
            <ul class="dataList">
              <li class="remove">
                ...
                <dsp:a title="${removeAddressTitle}" bean="MobileB2CProfileFormHandler.removeAddress" value="${editAddrNickname}"
                       href="${siteContextPath}/checkout/shipping.jsp" id="removeLink" iclass="icon-Remove">
                  <fmt:message key="mobile.common.button.deleteText"/>
                </dsp:a>
              </li>
            </ul>
          </div>
