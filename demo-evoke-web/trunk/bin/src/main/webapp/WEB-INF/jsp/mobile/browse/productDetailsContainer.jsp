<%--
  ...
  Page includes:
    ...
    /mobile/gadgets/gadgets/quantityPickerList.jsp - Renders a list of quantity selections
    /mobile/gadgets/relatedProducts.jsp - Related items
...
<dsp:page>
  ...
  <ul class="productDetails">
    ...
    <li class="itemDetails">
      <p class="detailsTitle"><fmt:message key="mobile.browse_moreDetails.details"/></p>
      ...
      <%-- Don't show "Related Products" if product has no related items --%>
      <%--
    ...
    <c:if test="${not empty relatedProducts}">
      <div class="itemsContainer">
        <%-- Display "Related Items" title --%>
        <div class="sliderTitle"><fmt:message key="mobile.productDetails.related"/></div>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/browse/productDetailsContainer.jsp#6 $$Change: 738325 $--%>
