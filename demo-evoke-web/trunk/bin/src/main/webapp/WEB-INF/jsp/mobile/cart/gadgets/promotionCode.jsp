...
<dsp:page>
  ...
  <div class="couponCode">
    ...
    <fmt:message var="promotionCode" key="mobile.common.cart.promotionCode"/>
    <c:choose>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/cart/gadgets/promotionCode.jsp#5 $$Change: 734360 $--%>
