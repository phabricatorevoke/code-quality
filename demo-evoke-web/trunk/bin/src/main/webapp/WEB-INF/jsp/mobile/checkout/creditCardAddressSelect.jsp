  ...
  <crs:mobilePageContainer titleString="${pageTitle}">
    <jsp:body>
      <div class="dataContainer">
        ...
        <%-- ========== Form ========== --%>
        <dsp:form action="billingCVV.jsp?dispatchCSV=newCardSelectedAddress" method="post">
          <%-- "Coupon code" --%>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/checkout/creditCardAddressSelect.jsp#3 $$Change: 713898 $--%>
