  ...
  <crs:mobilePageContainer titleString="${pageTitle}">
    <jsp:body>
      <div class="dataContainer">
        ...
        <%-- ========== Form ========== --%>
        <dsp:form formid="selectCreditCard" action="billingCVV.jsp?dispatchCSV=selectCard" method="post">
          <%-- ========== Redirection URLs ========== --%>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/checkout/selectCreditCard.jsp#3 $$Change: 713898 $--%>
