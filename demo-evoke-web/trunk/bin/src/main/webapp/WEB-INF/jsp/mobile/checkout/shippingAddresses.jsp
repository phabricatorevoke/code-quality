...
<dsp:page>
  ...
  <fmt:message var="pageTitle" key="mobile.common.foot.shipping"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/checkout/shippingAddresses.jsp#6 $$Change: 735278 $--%>
