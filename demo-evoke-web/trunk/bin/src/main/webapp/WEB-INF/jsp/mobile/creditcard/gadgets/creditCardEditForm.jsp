...
<dsp:page>
  ...
  <ul class="dataList" summary="" role="presentation" datatable="0">
    <li class="fixedHeight">
      ...
      <div class="left65 ${not empty errorMap['creditCardNickname'] ? 'errorState bottom' : ''}">
        <div class="content">
          <dsp:input type="hidden" bean="MobileB2CProfileFormHandler.editValue.nickname"/>
          <fmt:message var="nicknameLabel" key="mobile.common.nickName"/>
          <dsp:input bean="MobileB2CProfileFormHandler.editValue.newNickname" placeholder="${nicknameLabel}" aria-label="${nicknameLabel}"
      ...
      <div class="right35">
        <div class="content">
          <dsp:getvalueof var="creditCardType" bean="MobileB2CProfileFormHandler.editValue.creditCardType" vartype="java.lang.String"/>
      ...
      <div class="right60">
        <div class="content">
          <div class="month">
            ...
            <dsp:select id="cardExpirationDateMonthSelect" bean="MobileB2CProfileFormHandler.editValue.expirationMonth"
    ...
    <%-- "MobileB2CProfileFormHandler.editCard" has been previously set in caller page (credit cards list) --%>
    ...
    <c:choose>
      ...
      <c:when test="${page == 'checkout'}">
        <dsp:input type="hidden" bean="MobileB2CProfileFormHandler.editValue.newCreditCard" value="${defaultCardId == userCards[targetCardKey].repositoryId}"/>
      </c:when>  
      <c:otherwise/>
    </c:choose>
  ...
  <ul class="dataList" summary="" role="presentation" datatable="0">
    ...
    <dsp:include page="${mobileStorePrefix}/address/gadgets/addressAddEdit.jsp">
      <dsp:param name="formHandlerComponent" value="atg/userprofiling/MobileB2CProfileFormHandler.billAddrValue"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/creditcard/gadgets/creditCardEditForm.jsp#6 $$Change: 730046 $--%>
