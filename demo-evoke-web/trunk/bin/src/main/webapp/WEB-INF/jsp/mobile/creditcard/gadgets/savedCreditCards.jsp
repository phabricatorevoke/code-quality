                  ...
                  <div class="content">
                    ...
                    <label for="savedCreditCard${status.count}" onclick="">
                      ...
                      <c:if test="${isDefaultCard == 'true'}">
                        <span class="defaultLabel"><fmt:message key="mobile.common.defaultCreditCard"/></span>
                      </c:if>
                    </label>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/creditcard/gadgets/savedCreditCards.jsp#3 $$Change: 715743 $--%>
