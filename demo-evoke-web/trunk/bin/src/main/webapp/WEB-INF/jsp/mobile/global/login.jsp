<%--
  ...
  Required parameters:
    checkoutLogin
      ...
      inputs to the "CheckoutProfileFormHandler". Otherwise, "B2CProfileFormHandler" is used
...
<dsp:page>
  ...
  <fmt:message var="pageTitle" key="mobile.myaccount_login.title"/>
          ...
          <div class="content">
            <a href="javascript:void(0);" onclick="">
              <span class="parentSpan">
                <span class="title"><fmt:message key="mobile.navigation_loginLogout.login"/></span>
              ...
              <div class="content">
                ...
                <dsp:a page="/">
                  <span>
                    ...
                    <span class="title"><fmt:message key="mobile.navigation_loginLogout.logout"/></span>
                  </span>
                </dsp:a>
              </div>
            </li>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/global/login.jsp#3 $$Change: 713898 $--%>
