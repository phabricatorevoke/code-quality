              ...
              <li onclick="">
                ...
                <span class="storedAddressActions">
                  ...
                  <dsp:a href="${editURL}" title="${addrEditTitle}" class="icon-BlueArrow"
                         bean="MobileB2CProfileFormHandler.editAddress" paramvalue="shippingAddress.key"/>
                </span>
              </li>
            </c:if>
          </c:forEach>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/myaccount/gadgets/billingAddressesList.jsp#5 $$Change: 734357 $--%>
