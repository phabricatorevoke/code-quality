...
<dsp:page>
  ...
  <dsp:getvalueof var="formExceptions" bean="B2CProfileFormHandler.formExceptions"/>
    ...
    <jsp:body>
      ...
      <div class="dataContainer">
        ...
        <dsp:form action="${pageContext.request.requestURI}" method="post" formid="profilePasswordEdit">
          ...
          <%-- ========== Redirection URLs ========== --%>
          <dsp:input bean="B2CProfileFormHandler.changePasswordSuccessURL" type="hidden"
          ...
          <ul class="dataList" role="presentation">
            ...
            <li ${not empty errorMap['oldpassword'] || not empty errorMap['oldInvalid'] ? 'class="errorState"' : ''}>
              <div class="content">
                ...
                <dsp:input id="oldPassword" maxlength="35" bean="B2CProfileFormHandler.value.oldpassword"
            ...
            <li ${not empty errorMap['password'] || not empty errorMap['allEqual'] || not empty errorMap['requirements'] ? 'class="errorState"' : ''}>
              <div class="content">
                ...
                <dsp:input maxlength="35" bean="B2CProfileFormHandler.value.password"
            ...
            <li ${not empty errorMap['confirmpassword'] || not empty errorMap['notMatching'] ? 'class="errorState"' : ''}>
              <div class="content">
                ...
                <dsp:input maxlength="35" bean="B2CProfileFormHandler.value.confirmpassword"
          ...
          <div class="centralButton">
            ...
            <dsp:input bean="B2CProfileFormHandler.changePassword" class="mainActionButton" type="submit" value="${updateButton}"/>
          </div>
        </dsp:form>
      </div>
    </jsp:body>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/myaccount/profilePasswordEdit.jsp#3 $$Change: 713898 $--%>
