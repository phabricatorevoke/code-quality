          ...
          <dsp:form action="${originatingRequest.requestURI}" method="post" 
            ...
            <ul class="atg_store_basicForm">
              ...
              <li>
                ...
                <dsp:input id="atg_store_profileMyInfoEditDateOfBirth"  width="100" type="text" bean="RegistrationFormHandler.dateOfBirth" size="36"/>
                ...
                <span class="example">
                  ...
                  <fmt:formatDate var="formattedExampleDate" type="date" value="${exampleDate}" 
                                  pattern="${dateFormat}"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/myaccount/accountProfileEdit.jsp#1 $$Change: 713790 $--%>
