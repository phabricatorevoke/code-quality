<%--
  ...
  Optional parameters:
    checkout
      if this flag is true, do not display error messages from B2CProfileFormHandler   
--%>
<dsp:page>
    ...
    <dsp:form formid="atg_store_paymentInfoAddNewCardForm"   
      ...
      <fieldset class="atg_store_editCreditCard">
        ...
        <dsp:getvalueof var="creditCardNumber" 
                        bean="B2CProfileFormHandler.editValue.creditCardNumber" 
                        vartype="java.lang.String"/>
        ...
        <ul class="atg_store_basicForm">
          ...
          <li class="atg_store_expiration">
            ...
            <div class="atg_store_ccExpiration">
              <dsp:getvalueof var="selectedMonth" bean="B2CProfileFormHandler.editValue.expirationMonth"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/myaccount/gadgets/creditCardEdit.jsp#1 $$Change: 713790 $--%>