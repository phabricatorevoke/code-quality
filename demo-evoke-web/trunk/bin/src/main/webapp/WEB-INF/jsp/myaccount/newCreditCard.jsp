                    ...
                    <ul class="atg_store_basicForm atg_store_addNewAddress">
                      ...
                      <li>
                        ...
                        <dsp:input type="text" id="atg_store_paymentInfoAddNewCardAddressNickname" 
                                   ...
                                   bean="B2CProfileFormHandler.billAddrValue.shippingAddrNickname" />
                      </li>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/myaccount/newCreditCard.jsp#1 $$Change: 713790 $--%>
