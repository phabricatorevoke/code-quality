...
<dsp:page>
  ...
  <dsp:getvalueof var="originatingRequestURL" bean="/OriginatingRequest.contextPath"/> 
  <dsp:getvalueof var="actionPath" bean="/atg/endeca/assembler/cartridge/manager/DefaultActionPathProvider.defaultExperienceManagerNavigationActionPath"/> 
      ...
      <dsp:droplet name="RangeSortDroplet">
        ...
        <dsp:oparam name="outputStart">
          ...
          <div class="atg_store_filter">
            ...
            <dsp:form id="sortByForm" action="${originatingRequestURL}${actionPath}/${contentItem.categoryAction}">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/browse/gadgets/categoryChildProductsRenderer.jsp#5 $$Change: 739483 $ --%>