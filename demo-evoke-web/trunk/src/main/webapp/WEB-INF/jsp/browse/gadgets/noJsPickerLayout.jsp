        ...
        <dsp:droplet name="ColorSizeDroplet">
          ...
          <dsp:oparam name="output">      
            <dsp:form method="post" action="${uri}" id="pickerForm" formid="pickerForm">
              ...
              <dsp:input type="hidden" bean="CartFormHandler.skuType" value="clothing" />
              ...
              <div class="atg_store_addQty">
                <div class="atg_store_quantity">
                  ...
                  <dsp:input bean="CartFormHandler.quantity" class="atg_store_quantityField_nojs" value="1"
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/browse/gadgets/noJsPickerLayout.jsp#1 $$Change: 713790 $--%>
