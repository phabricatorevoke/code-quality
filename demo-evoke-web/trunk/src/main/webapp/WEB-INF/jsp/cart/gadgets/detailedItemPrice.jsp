<%-- 
  This page displays price details for each item.
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/gadgets/detailedItemPrice.jsp#1 $$Change: 713790 $--%>