...
<dsp:page>
  ...
  <div class="atg_store_main" id="atg_store_shoppingCart">
    <div id="atg_store_gwpContainer">
      ...
      <a href="#" class="atg_store_gwpClose" onclick="dijit.byId('giftSelectorDialog').hide();"><fmt:message key="common.closeWindowText"/></a>
                                   ...
                                   <div class="atg_store_pickerContainer">
                                     <div class="atg_store_colorPicker">
                                       <label class="atg_store_pickerLabel">
                                         <fmt:message key="common.${skuType == 'clothing-sku' ? 'color' : 'woodFinish'}"/><fmt:message key="common.labelSeparator"/>
                                       </label>     
                                       <span class="selector">
    ...
    <div id="atg_store_gwpFooter">
      ...
      <c:choose>
        <c:when test="${itemsOutOfStock ne true}"> 
          ...
          <dsp:form id="gwpform" name="gwpform" formid="gwpform" action="${originatingRequest.requestURI}" method="post" >
            ...
            <span class="atg_store_basicButton add_to_cart_link">
              ...
              <dsp:input type="submit" priority="-1"
                           ...
                           value="${addToCartCaption}" onclick="atg.store.picker.clickAddGWithPurchaseToCart(this, '${addingToCartText}'); return false;"/> 
            </span>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/gadgets/giftSelection.jsp#1 $$Change: 713790 $--%>
