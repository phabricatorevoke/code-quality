          ...
          <dsp:oparam name="true">
            ...
            <dsp:droplet name="TargetingFirst">
              ...
              <dsp:oparam name="output">
                ...
                <li>
                  <dsp:input type="hidden" bean="CartFormHandler.giftWrapSkuId" paramvalue="targetedProduct.childSkus[0].repositoryId"/>
                  <dsp:input type="hidden" bean="CartFormHandler.giftWrapProductId" paramvalue="targetedProduct.repositoryId"/>
                  ...
                  <dsp:a href="${pageContext.request.contextPath}/cart/gadgets/giftWrapDetailsPopup.jsp" target="popup">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/gadgets/giftWrap.jsp#1 $$Change: 713790 $--%>