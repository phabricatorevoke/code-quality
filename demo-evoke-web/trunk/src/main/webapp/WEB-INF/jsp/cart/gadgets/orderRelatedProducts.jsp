...
<dsp:page>
  ...
  <%--
    ...
    Input Parameters:
      ...
      howMany - the maximum number of targeted items to return
      
      fireViewItemEvent - A boolean indicating whether this type of event should
                          be fired
   
     Open Parameters:
       outputStart - Rendered before any output tags if the result array is not
                     empty
       
       output - At least 1 target was found
       
       outputEnd - Rendered after all output tags if the result array is not
                   empty
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/gadgets/orderRelatedProducts.jsp#1 $$Change: 713790 $--%>
