...
<dsp:page>
  ...
  <json:object>
    ...
    <json:property name="imageUrl">
      ...
      <c:out value="${imageUrl}" default="/crsdocroot/content/images/products/small/MissingProduct_small.jpg" escapeXml="false"/>         
    </json:property>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/json/cartItem.jsp#2 $$Change: 713816 $--%>
