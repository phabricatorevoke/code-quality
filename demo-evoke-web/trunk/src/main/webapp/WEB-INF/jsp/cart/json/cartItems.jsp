...
<dsp:page>
  ...
  <json:object name="itemsContainer">
    ...
    <json:array name="items">
        ...
        <c:if test="${commerceItemClassType != 'giftWrapCommerceItem'}">
          ...
          <dsp:droplet name="GiftWithPurchaseSelectionsDroplet">
            ...
            <dsp:oparam name="output">
              ...
              <%--
                Include free gift item. 
                Pass special 'isGift' flag to hide item's price
      ...
      <%-- 
        Append gift place holders
        
        Input Parameters:
          order
            current order from the cart
          onlyOutputAvailableSelections
            true flag means that only selections 
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/json/cartItems.jsp#1 $$Change: 713790 $--%>
