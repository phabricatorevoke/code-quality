...
<%--
  This page renders any CartFormHandler formExceptions.
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/cart/json/errors.jsp#1 $$Change: 713790 $--%>
