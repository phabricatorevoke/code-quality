    ...
    <div class="atg_store_facetsGroup_options_catsub">
      ...
      <script type="text/javascript">
        ...
        dojo.extend(dojox.form.HorizontalRangeSlider, {
          ...
          toggleFocusOutline: function(){
            dojo.query(this).children(".dijitSliderImageHandle").toggleClass("inFocus");
          },
          ...
          addConnections: function(){
            ...
            this.connections.push(
              dojo.connect(this.sliderHandle, "focus", this.sliderHandle, this.toggleFocusOutline)
            );
            ...
            this.connections.push(
              dojo.connect(this.sliderHandle, "blur", this.sliderHandle, this.toggleFocusOutline)
            );
            ...
            this.connections.push(
              dojo.connect(this.sliderHandleMax, "focus", this.sliderHandleMax, this.toggleFocusOutline)
            );
            ...
            this.connections.push(
              dojo.connect(this.sliderHandleMax, "blur", this.sliderHandleMax, this.toggleFocusOutline)
            );
