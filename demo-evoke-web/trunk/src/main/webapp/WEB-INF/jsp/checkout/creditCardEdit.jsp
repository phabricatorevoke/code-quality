  ...
  <crs:pageContainer divId="atg_store_cart" 
    ...
    <jsp:attribute name="formErrorsRenderer">
     <%-- 
       ...
       this page operates with B2CProfileFormHandler only. 
     --%>
    ...
    <jsp:body>
      ...
      <crs:checkoutContainer currentStage="${stage}" title="${title}">
        <jsp:attribute name="formErrorsRenderer">
          <%-- Render page errors, this page operates with B2CProfileFormHandler only. --%>
          <div id="atg_store_formValidationError">
            <dsp:include page="/myaccount/gadgets/myAccountErrorMessage.jsp">
              <dsp:param name="formHandler" bean="B2CProfileFormHandler"/>
              <dsp:param name="submitFieldText" value="${submitText}"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/creditCardEdit.jsp#1 $$Change: 713790 $--%>
