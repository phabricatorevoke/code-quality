<%--
  This page displays a list of available shipping addresses. For each non-gift shipping address, there will be displayed an 'Edit/Remove'
  buttons.
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/editShippingAddresses.jsp#1 $$Change: 713790 $--%>
