<%--
  This gadget lists the user's saved billing addresses as options when adding a new credit card during the checkout process.

  Required parameters:
    availableBillingAddresses - An array of permitted nickname=HardgoodShippingGroup pairs 
                                (Map.Entrys) taken from the ShippingGroupContainerService.shippingGroupMap
      ...
      <div class="atg_store_addressGroup">
        <dl class="atg_store_billingAddresses atg_store_savedAddresses">
          ...
          <dd class="atg_store_storedAddressActions">
            <ul>
              <li>
                <dsp:getvalueof var="successURL" vartype="java.lang.String" value="${pageContext.request.contextPath}/checkout/billing.jsp"/>
                <dsp:a bean="B2CProfileFormHandler.editAddress" page="../billingAddressEdit.jsp" value="${shippingGroupNickname}">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/gadgets/billingAddresses.jsp#1 $$Change: 713790 $--%>
