      ...
      <c:forEach var="formException" items="${formExceptions}">
        ...
        <c:choose>
          <c:when test='${errorCode == "missingRequiredValue" || errorCode == "missingRequiredAddressProperty"}'>
            <%--
              We should display only one 'Additinal Information Required' error per page (request).
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/gadgets/checkoutErrorMessages.jsp#1 $$Change: 713790 $--%>
