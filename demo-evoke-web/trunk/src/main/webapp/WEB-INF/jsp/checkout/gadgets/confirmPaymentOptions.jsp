  ...
  <c:choose>
    ...
    <c:otherwise>
      ...
      <c:forEach var="paymentGroupRelationship" items="${paymentGroupRelationships}">
        ...
        <!-- This block displays the paypal payment details -->
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/gadgets/confirmPaymentOptions.jsp#2 $$Change: 729616 $--%>