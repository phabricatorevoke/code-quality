...
<dsp:page>
  ...
  <%--
    This droplet operates with shipping-related objects. It can remove all objects or create new.
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/gadgets/confirmResponse.jsp#1 $$Change: 713790 $--%>
