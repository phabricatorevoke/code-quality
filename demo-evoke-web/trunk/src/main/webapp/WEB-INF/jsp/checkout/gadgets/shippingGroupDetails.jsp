<%--
  ...
  It also displays Edit and Remove buttons, the former opens an 'Edit Shipping Address' page and the latter removes a shipping address
  with name equal to group's name.
          ...
          <ul class="atg_store_storedAddressActions">
            ...
            <li class="<crs:listClass count="${count}" size="2" selected="false"/>">
              <dsp:a title="${editAddressTitle}"
                ...
                <dsp:param name="successURL" value="${pageContext.request.contextPath}${editShippingAddressSuccessURL}"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/gadgets/shippingGroupDetails.jsp#1 $$Change: 713790 $--%>