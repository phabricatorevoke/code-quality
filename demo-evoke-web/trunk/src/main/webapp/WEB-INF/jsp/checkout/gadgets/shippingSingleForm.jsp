<%-- 
  This container page renders the shipping-single form contents. It renders necessary hidden fields and includes shippingAddresses.jsp
  and shippingForm.jsp pages.
  ...
  <div id="atg_store_checkout" class="atg_store_main"> 
    ...
    <c:if test="${not empty shippingGroupMap}">
      ...
      <%-- 
        ...
        Input parameters:
          defaultKey - The parameter that defines the map key of the default item that should be
        ...
        Open parameters:
          output - Rendered for permitted shipping address list, permittedAddresses parameter
    ...
    <div class="${!empty permittedAddresses ?'atg_store_existingAddresses ':''}atg_store_checkoutOption" id="atg_store_checkoutOptionArea"> 
      ...
      <div id="atg_store_createNewShippingAddress">
        ...
        <fieldset class="atg_store_createNewShippingAddress">
          ...
          <dsp:input type="hidden" bean="ShippingGroupFormHandler.shipToNewAddressErrorURL" value="shipping.jsp"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/gadgets/shippingSingleForm.jsp#1 $$Change: 713790 $--%>
