          ...
          <jsp:body>
            <div id="atg_store_checkout" class="atg_store_main">
              ...
              <div class="atg_store_enterGiftMessage">
                <dsp:input type="hidden" bean="GiftMessageFormHandler.addGiftMessageErrorURL" value="${pageContext.request.requestURI}"/>
                ...
                <ul class="atg_store_basicForm atg_store_addGiftNote">
                  ...
                  <li>
                    ...
                    <dsp:textarea bean="GiftMessageFormHandler.giftMessage"  iclass="required" cols="30" rows="5" name="giftmessage"
                                  default="${message}" id="atg_store_messageInput"/>
                    <span class="example">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/giftMessage.jsp#1 $$Change: 713790 $--%>
