    ...
    <jsp:body>
      <div id="atg_store_whatsThisPopupContent">
        ...
        <div class="atg_Store_visa">
          <h3><fmt:message key="common.visa"/>, <fmt:message key="common.masterCard"/>, <fmt:message key="common.discover"/></h3>
        ...
        <div class="atg_store_amex">
          <h3><fmt:message key="common.americanExpress"/></h3>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/checkout/whatsThisPopup.jsp#1 $$Change: 713790 $ --%>
