      ...
      <table style="border-collapse: collapse; width: 215px;" summary="" role="presentation">
        <tr>
          ...
          <td style="color:#666666;font-size:12px;font-family:Tahoma,Arial,sans-serif; width: 150px; ">
            ...
            <%-- 
            Get discount message from the promotion.
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/emailtemplates/gadgets/emailOrderGiftItem.jsp#2 $$Change: 732131 $--%>