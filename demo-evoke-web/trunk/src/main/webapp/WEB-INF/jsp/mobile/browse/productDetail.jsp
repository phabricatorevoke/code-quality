    ...
    <jsp:body>
      ...
      <script type="text/javascript">
        $(document).ready(function() {
          ...
          <%-- This is to initialize "Recently Viewed Items" in "productDetailsContainer.jsp" --%>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/browse/productDetail.jsp#4 $$Change: 733297 $--%>
