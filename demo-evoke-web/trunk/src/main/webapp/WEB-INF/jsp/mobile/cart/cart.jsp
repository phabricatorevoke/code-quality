    ...
    <jsp:attribute name="modalContent">
      ...
      <div class="shareDialog" onclick="$(this).hide();">
        <div class="shareItems">
          <ul class="dataList">
            <li>
              <a id="shareLink" class="icon-Share" role="button" href="javascript:void(0);"><fmt:message key="mobile.browse_emailAFriend.title"/></a>
            </li>
          </ul>
        </div>
      </div>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/cart/cart.jsp#6 $$Change: 734343 $ --%>
