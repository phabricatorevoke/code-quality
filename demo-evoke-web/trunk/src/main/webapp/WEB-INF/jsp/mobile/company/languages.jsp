...
<dsp:page>
  ...
  <fmt:message var="pageTitle" key="mobile.navigation_languages.languagesTitle"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/company/languages.jsp#3 $$Change: 713898 $ --%>
