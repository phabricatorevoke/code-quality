            ...
            <dsp:droplet name="ForEach">
              ...
              <dsp:oparam name="output">
                ...
                <li class="icon-ArrowLeft" onclick="CRSMA.global.storeLocationClick(this);">
                  <p class="storeName"><dsp:valueof param="storeItem.storeName"/></p>
                  <p>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/company/stores.jsp#4 $$Change: 735007 $ --%>
