        ...
        <div class="moveItems">
          <ul class="dataList">
            <li class="remove">
              ...
              <dsp:a title="${removeCard}" bean="MobileB2CProfileFormHandler.removeCard" value="${cardNickname}"
    ...
    <jsp:body>
      ...
      <div class="dataContainer">
        ...
        <dsp:form formid="editCreditCard" action="${pageContext.request.requestURI}" method="post">
          ...
          <dsp:input type="hidden" bean="MobileB2CProfileFormHandler.updateCardSuccessURL" value="${successURL}"/>
          <dsp:input type="hidden" bean="MobileB2CProfileFormHandler.updateCardErrorURL" value="${errorURL}"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/creditcard/editCreditCard.jsp#3 $$Change: 730046 $--%>
