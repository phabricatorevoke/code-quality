      ...
      <li class="icon-ArrowLeft ${not empty errorMap['creditCardType'] ? 'errorState' : ''}">
        <div class="content">
          ...
          <dsp:select id="paymentInfoAddNewCardCardType" bean="${cardParamsMap}.creditCardType"
            ...
            <dsp:option value="Visa" role="option"><fmt:message key="mobile.card.visa"/></dsp:option>
            <dsp:option value="MasterCard" role="option"><fmt:message key="mobile.card.masterCard"/></dsp:option>
            <dsp:option value="AmericanExpress" role="option"><fmt:message key="mobile.card.americanExpress"/></dsp:option>
            <dsp:option value="Discover" role="option"><fmt:message key="mobile.card.discover"/></dsp:option>
          </dsp:select>
        </div>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/creditcard/gadgets/creditCardAddForm.jsp#5 $$Change: 735762 $--%>
