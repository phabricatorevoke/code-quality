    ...
    <c:choose>
      ...
      <c:otherwise>
        ...
        <div class="cartData">
          <span class="content">
            <c:choose>
              <c:when test="${order.storeCreditsAppliedTotal == 0}">
                <dsp:include page="${mobileStorePrefix}/creditcard/gadgets/creditCardRenderer.jsp">
                  <dsp:param name="creditCard" param="paymentGroup"/>
                  <dsp:param name="showFullInfo" value="true"/>
                </dsp:include>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/global/gadgets/reviewPayment.jsp#4 $$Change: 734360 $--%>
