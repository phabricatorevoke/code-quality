    ...
    <jsp:body>
      ...
      <div class="dataContainer">
        ...
        <dsp:form action="${pageContext.request.requestURI}" method="post">
          <%-- ========== Redirection URLs ========== --%>
          <dsp:input type="hidden" bean="MobileB2CProfileFormHandler.createCardSuccessURL" value="selectCreditCard.jsp"/>
          <dsp:input type="hidden" bean="MobileB2CProfileFormHandler.createCardErrorURL" value="newCreditCard.jsp"/>

          <dsp:include page="gadgets/billingAddressesList.jsp"/>

          <dsp:input type="hidden" bean="MobileB2CProfileFormHandler.createNewCreditCard" value="createNewCreditCard" priority="-10"/>
        </dsp:form>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/myaccount/creditCardAddressSelect.jsp#3 $$Change: 713898 $--%>
