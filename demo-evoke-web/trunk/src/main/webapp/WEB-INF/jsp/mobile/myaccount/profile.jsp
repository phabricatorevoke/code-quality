    ...
    <div class="dataContainer">
      <ul class="dataList" role="presentation">
        <li>
          <div class="left30">
            <%-- "Logout" --%>
            <fmt:message var="logout" key="mobile.navigation_loginLogout.logout"/>
            <dsp:getvalueof id="userLocale" vartype="java.lang.String" bean="RequestLocale.locale"/>
            <dsp:a page="/" title="${logout}">
              <span class="content">
                <dsp:property bean="B2CProfileFormHandler.logoutSuccessURL" value="mobile/myaccount/login.jsp?locale=${userLocale}"/>
...
<%-- @updated $DateTime: 2012/08/06 06:37:28 $$Author: pmacrory $ --%>
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/mobile/myaccount/profile.jsp#4 $$Change: 715700 $--%>
