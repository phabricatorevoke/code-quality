...
<dsp:page>
  ...
  <dsp:setvalue bean="B2CProfileFormHandler.editCard" paramvalue="nickName"/> 
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/myaccount/accountCardEdit.jsp#1 $$Change: 713790 $--%>
