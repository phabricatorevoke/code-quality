  ...
  <dsp:form action="${pageContext.request.requestURI}" 
    ...
    <c:choose>
      <c:when test="${addEditMode == 'edit'}">
        ...
        <dsp:setvalue bean="B2CProfileFormHandler.editAddress" paramvalue="nickName"/> 
      </c:when>
      <c:otherwise>        
        <c:choose>
          ...
          <c:when test="${addEditMode == 'edit'}">
            ...
            <div class="atg_store_formActionItem">
              <span class="atg_store_basicButton">
                <dsp:input bean="B2CProfileFormHandler.updateAddress" 
            ...
            <div class="atg_store_formActionItem">
              <span class="atg_store_basicButton secondary">
                <dsp:input bean="B2CProfileFormHandler.cancel" 
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/myaccount/gadgets/addressEdit.jsp#1 $$Change: 713790 $ --%>
