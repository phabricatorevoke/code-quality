    ...
    <dsp:oparam name="output">
      ...
      <td class="quantity_fav_actions quantity">
        ...
        <dsp:form action="${originatingRequest.requestURI}" 
          ...
          <dsp:input bean="CartFormHandler.quantity" iclass="qty atg_store_numericInput" 
          ...
          <div class="wishList_actions">
            ...
            <c:choose>
              <c:when test="${not empty addButtonText}">
                ...
                <dsp:input bean="CartFormHandler.giftlistId" paramvalue="giftlistId" type="hidden"/>
                <dsp:input bean="CartFormHandler.giftlistItemId" value="${giftItemId}" type="hidden"/>
    
                <%-- The only submit we got --%>
                <span class="atg_store_basicButton add_to_cart_link">
                  <dsp:input bean="CartFormHandler.addItemToOrder" 
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/myaccount/gadgets/wishListRow.jsp#2 $$Change: 713816 $--%>
