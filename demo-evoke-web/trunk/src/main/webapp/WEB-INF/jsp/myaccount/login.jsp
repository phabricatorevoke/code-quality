  ...
  <crs:pageContainer index="false" follow="false" 
    ...
    <jsp:attribute name="formErrorsRenderer">
      ...
      <%-- 
        ...
        myaccount/gadgets/preRegister.jsp form) and B2CProfileFormHandler (used on
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/myaccount/login.jsp#1 $$Change: 713790 $--%>
