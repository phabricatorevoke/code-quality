            ...
            <span class="atg_store_welcome">
              ...
              <fmt:message key="navigation.welcomeback">
                <fmt:param>
                  ...
                  <strong><c:out value="${firstName}"/></strong>
                </fmt:param>
              </fmt:message>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.1.2/Storefront/j2ee/store.war/navigation/gadgets/welcome.jsp#1 $$Change: 713790 $ --%>
